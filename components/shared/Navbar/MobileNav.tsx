          ...
          <SignedOut>
            <div className="flex flex-col gap-3">
              <SheetClose asChild className="border-none">
                <Link href="/sign-in">
                  <Button className="small-medium btn-secondary w-full rounded-lg px-4 py-3 shadow-none min-h-[41px]">
              ...
              <SheetClose asChild className="border-none">
                <Link href="/sign-up">
                  <Button className="small-medium light-border-2 btn-tertiary w-full rounded-lg px-4 py-3 shadow-none min-h-[41px] text-dark400_light900">
                    Sign Up
                  </Button>
                </Link>
              </SheetClose>
